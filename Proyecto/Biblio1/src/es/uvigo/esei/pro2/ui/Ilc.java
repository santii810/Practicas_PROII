...
public class Ilc {
    ...
    private void modificaReferencia(Referencia r)
    {
        ...
        switch (tipoReferencia){
            case 'L': r.setTipo(Referencia.Tiporeferencia.LIBRO.toString());
                      break;
            case 'A': r.setTipo(Referencia.Tiporeferencia.ARTICULOREVISTA.toString());
                      break;
            case 'D': r.setTipo(Referencia.Tiporeferencia.DOCUMNETOWEB.toString());
                      break;                
        }
